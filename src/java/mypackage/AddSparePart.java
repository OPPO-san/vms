...
public class AddSparePart extends HttpServlet {
  ...
  */ 
        ...
        String query2 = "INSERT INTO spare_part (SPAREPART_ID,PART_NAME,COST,QUANTITY) VALUES (?,?,?,?)";
        PreparedStatement insertUser = connection.prepareStatement(query2);
        insertUser.setString(1,part_id);
        insertUser.setString(2,part_name);
        insertUser.setString(3,cost);
        insertUser.setString(4,quantity);
        insertUser.executeUpdate();

        System.out.println("New Spare Part has been added in database");
